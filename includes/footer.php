<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Stamford Bridge.<br>
				#3222, Fulham Rd, Fulham, London SW6 1HS, United Kingdom.
			</address>
				<div class="phone">
					Telephone:
				...
				<div class="email">
					Email:
					<a href="mailto:support@candyshop.com" class="email__addr">support@candyshop.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2020 CandyShop&trade;
			</div>

			<div class="developer">
				Design by Aakash & Parashar
			</div>
