...
<div class="panel panel-default sidebar-menu"><!-- panel panel-default sidebar-menu Starts -->
		...
		<h3 class="panel-title"><!-- panel-title Starts -->
			...
			<div class="pull-right"><!-- pull-right Starts -->
				...
				<a href="#" style="color:black;">
					...
					<span class="nav-toggle hide-show" id="man_sidebar_hide">
	...
	<div class="panel-collapse collapse-data" id="man_collapse"><!-- panel-collapse collapse-data starts -->
		...
		<div class="panel-body scroll-menu"><!-- panel-body scroll-menu Starts -->
			...
			<ul class="nav nav-pills nav-stacked category-menu" id="dev-manufacturer"><!-- nav nav-pills nav-stacked category-menu Starts -->
				...
				$get_manfacturer = "select * from manufacturers  where manufacturer_top='yes' Order By manufacturer_title ";
				...
				$get_manfacturer = "select * from manufacturers where manufacturer_top='no' Order By manufacturer_title";
...
<div class="panel panel-default sidebar-menu"><!--- panel panel-default sidebar-menu Starts -->
		...
		<h3 class="panel-title"><!-- panel-title Starts -->
			...
			<div class="pull-right"><!-- pull-right Starts -->
				...
				<a href="#" style="color:black;">
					...
					<span class="nav-toggle hide-show" id="product_sidebar_hide">
	...
	<div class="panel-collapse collapse-data" id="product_collapse"><!-- panel-collapse collapse-data Starts -->
		...
		<div class="panel-body scroll-menu"><!-- panel-body scroll-menu Starts -->
			...
			<ul class="nav nav-pills nav-stacked category-menu" id="dev-p-cats"><!-- nav nav-pills nav-stacked category-menu Starts -->
				...
				$get_p_cats = "select * from product_categories where p_cat_top='yes' Order by p_cat_title";
				...
				$get_p_cats = "select * from product_categories where p_cat_top='no' Order by p_cat_title";
