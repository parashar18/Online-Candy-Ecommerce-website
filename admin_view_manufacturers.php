...
$get_manufacturers = "select * from manufacturers where status='a'";
...
<a href="admin_delete_manufacturer.php?delete_manufacturer=<?php echo $manufacturer_id; ?>">
...
<a href="admin_edit_manufacturer.php?edit_manufacturer=<?php echo $manufacturer_id; ?>">
