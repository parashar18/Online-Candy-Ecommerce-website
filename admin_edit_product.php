						...
						<form class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
							...
							<div class="form-group" ><!-- form-group Starts -->
								...
								<div class="col-md-6" >
									...
									<input type="text" name="product_quantity" class="form-control" required value="<?php echo $p_quantity; ?>">
							...
							<div class="form-group" ><!-- form-group Starts -->
								...
								<div class="col-md-6" >
									...
									<input type="text" name="product_desc" class="form-control" value="<?php echo $p_desc; ?>" required >
...
//$cat = $_POST['cat'];
		...
		$update_product = "update products set p_cat_id='$product_cat',manufacturer_id='$manufacturer_id',date=NOW(),product_title='$product_title',product_url='$product_url',product_img1='$product_img1',product_img2='$product_img2',product_img3='$product_img3',product_price='$product_price',product_psp_price='$psp_price',product_desc='$product_desc',product_quantity='$product_quantity', product_keywords='$product_keywords',product_label='$product_label' where product_id='$p_id'";
