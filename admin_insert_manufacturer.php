...
$insert_manufacturer = "insert into manufacturers (manufacturer_title,manufacturer_top,manufacturer_image, status) values ('$manufacturer_name','$manufacturer_top','$manufacturer_image','a')";
...
echo "<script>window.open('admin_view_manufacturers','_self')</script>";
